...
class MonteCarlo:
    ...
    def __init__(self):
        ...
        self.arr_pickle = [] # Used later for saving the equilibrated lattice states
    ...
    def run_simulation(self):
        ...
        for count, mu in enumerate(self.args.mu_list):
            ...
            self.arr_pickle.append(copy.deepcopy(self.lattice))
            print(self.arr_pickle)
        
        
        
        # Now pickle the equilibrium states
        # Syntax for pickling was learnt from the YouTube channel sentdesk
        # pickle_out = open('equilibrium.pickle', 'wb')
        # pickle.dump(self.arr_pickle, pickle_out)
        # pickle_out.close()
        # The pickle is saved in the script directory

        """
        Switching off any averaging steps and analysis
        """
